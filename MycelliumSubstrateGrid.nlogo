...
to setup
  ...
  ask patches [
    ...
    if ( pxcor > -20 ) and ( pxcor <= 20 ) and ( pycor > 20 ) and ( pycor <= 60 ) [
      set pcolor 121
      set quadrant 8
    ]
    if ( pxcor > -60 ) and ( pxcor <= -20 ) and ( pycor > 20 ) and ( pycor <= 60 ) [
      set pcolor 114
      set quadrant 9
    ]
    if ( pxcor >= -100 ) and ( pxcor <= -60 ) and ( pycor > 20 ) and ( pycor <= 60 ) [
      set pcolor 113
      set quadrant 10
    ]
    ...
    if ( pxcor > 60 ) and ( pycor > -20 ) and ( pycor <= 20 ) [
      set pcolor 103
      set quadrant 11
    ]
    if ( pxcor > 20 ) and ( pxcor <= 60 ) and ( pycor > -20 ) and ( pycor <= 20 ) [
      set pcolor 97
      set quadrant 12
    ]
    ...
    if ( pxcor > -60 ) and ( pxcor <= -20 ) and ( pycor > -20 ) and ( pycor <= 20 ) [
      set pcolor 97
      set quadrant 14
    ]
    if ( pxcor >= -100 ) and ( pxcor <= -60 ) and ( pycor > -20 ) and ( pycor <= 20 ) [
      set pcolor 93
      set quadrant 15
    ]
    ...
    if ( pxcor > 60 ) and ( pycor > -60 ) and ( pycor <= -20 ) [
      set pcolor 85
      set quadrant 16
    ]
    if ( pxcor > 20 ) and ( pxcor <= 60 ) and ( pycor > -60 ) and ( pycor <= -20 ) [
      set pcolor 97
      set quadrant 17
    ]
    if ( pxcor > -20 ) and ( pxcor <= 20 ) and ( pycor > -60 ) and ( pycor <= -20 ) [
      set pcolor 97
      set quadrant 18
    ]
    if ( pxcor > -60 ) and ( pxcor <= -20 ) and ( pycor > -60 ) and ( pycor <= -20 ) [
      set pcolor 97
      set quadrant 19
    ]
    if ( pxcor >= -100 ) and ( pxcor <= -60 ) and ( pycor > -60 ) and ( pycor <= -20 ) [
      set pcolor lime
      set quadrant 20
    ]
    ...
    if ( pxcor > 60 ) and ( pycor >= -101 ) and ( pycor <= -60 ) [
      set pcolor 85
      set quadrant 21
    ]
    if ( pxcor > 20 ) and ( pxcor <= 60 ) and ( pycor >= -101 ) and ( pycor <= -60 ) [
      set pcolor 97
      set quadrant 22
    ]
    if ( pxcor > -20 ) and ( pxcor <= 20 ) and ( pycor >= -101 ) and ( pycor <= -60 ) [
      set pcolor 97
      set quadrant 23
    ]
    if ( pxcor > -60 ) and ( pxcor <= -20 ) and ( pycor >= -101 ) and ( pycor <= -60 ) [
      set pcolor 97
      set quadrant 24
    ]
    if ( pxcor >= -100 ) and ( pxcor <= -60 ) and ( pycor >= -101 ) and ( pycor <= -60 ) [
      set pcolor 97
      set quadrant 25
    ]
